...
* **Empirical Trade-off:** 1,000 Monte Carlo trials demonstrate 0.6953 mean transition ROC-AUC (P95 = 0.9017), 10.8% false-alarm rate on non-bifurcation negative controls (vs 88.0% for static thresholding), and normalized lead time $L_{\text{norm}} = 0.068$, while the shuffled surrogate collapses to chance (AUC = 0.4995).
